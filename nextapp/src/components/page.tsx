...
export default function Page({ children, background }: any) {
    return <main className="min-h-screen sm:px-20 p-5 text-white"
        ...
        <Navbar />
        <main className={`p-5 my-10 flex flex-col items-center ${background ? "bg-black/30 ring-4 ring-white/20" : ""}`}>
            {children}
        </main>
    </main>
}